...
const Icons = {
  ...
  news: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 4.5h-15A2.25 2.25 0 0 0 2.25 6.75v10.5A2.25 2.25 0 0 0 4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5Zm-13.5 4.5h6m-6 3h12m-12 3h12" />
    </svg>
  ),
};
...
const navItems = [
  ...
  { href: '/admin/news', label: 'Basında Biz', icon: Icons.news, section: 'içerik' },
...
const pageMetadata: Record<string, { title: string; subtitle: string }> = {
  ...
  '/admin/news': { title: 'Basında Biz', subtitle: 'Basın haberleri ve dış bağlantılar' },
